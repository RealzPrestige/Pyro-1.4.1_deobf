...
public class ColorUtil
{
    ...
    public ColorUtil(final Color p_ColorBase) {
        ...
        this.m_Alpha = p_ColorBase.getAlpha() / 255.0f;
    }
    ...
    public static String GenerateMCColorString(final String p_String) {
        final char c = 'q';
        final char c2 = '\u0018';
        ...
        while (i >= 0) {
            ...
            --n;
            array3[n2] = (char)(char1 ^ 'q');
            if (n < 0) {
                break;
            }
            final char[] array4 = array2;
            final int n3 = n--;
            array4[n3] = (char)(p_String.charAt(n3) ^ '\u0018');
            i = n;
        }
